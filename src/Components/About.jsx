    ...
    <>
      ...
      <section id="about" className="bg-[#0f1311] text-[#d6b179] py-20 px-6 md:px-20 text-center relative">
        ...
        <p className="text-white max-w-3xl mx-auto text-base md:text-lg leading-7 font-light mt-6">
          Welcome to <strong>Flavours by Sahiba</strong> – where every bite celebrates culture, comfort, and creativity.
          Located in the heart of Chittagong, our journey began with a simple goal: to serve soulful food with a unique twist.
          From crispy South Indian delicacies and flavorful appetizers to rich, aromatic coffees and refreshing drinks,
          every item on our menu is thoughtfully prepared to delight your senses. Whether you're here for a cozy meal or a
          quick sip with friends, we’re proud to offer a welcoming space filled with great taste and warm hospitality.
          Thank you for being part of our story — we look forward to serving you again and again.
        </p>
        <Link to="#hero" className="absolute bottom-6 right-6 w-10 h-10 flex items-center justify-center border border-[#d6b179] rounded-full text-[#d6b179] hover:bg-[#d6b179] hover:text-black transition">
